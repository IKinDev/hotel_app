...
class PaymentAppBarWidget extends StatelessWidget
    implements PreferredSizeWidget {
  final double height;
  const PaymentAppBarWidget({super.key, required this.height});
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      leading: IconButton(
        ...
        onPressed: () =>
            Navigator.pop(context, MainNavigationRoutesName.reservationRoom),
      ),
